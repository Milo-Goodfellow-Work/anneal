...
async def _submit_to_aristotle(
    ...
    try:
        ...
        # Create a minimal valid Verif.lean that imports Main.lean
        # Don't hardcode theorem signatures - let Aristotle figure out what to prove
...
"""
        ...
        # CRITICAL: Verify the project builds with Verif.lean included
        # This ensures Aristotle can load the project environment
        ...
        result = await aristotlelib.Project.prove_from_file(
            input_file_path=str(verif_path.relative_to(ctx["spec_pkg_root"])),
        ...
        if result:
            result_path = ctx["spec_pkg_root"] / result
